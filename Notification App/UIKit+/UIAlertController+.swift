...
extension UIAlertController {
    ...
    static func editPageNameAlert(textFieldDelegate: WorkspaceColumnVC, pageName: String, doneAction: @escaping (_ text: String)->Void, cancelAction: @escaping ()->Void) -> UIAlertController {
        let ac = UIAlertController(title: "Edit Page Name", message: nil, preferredStyle: .alert)
