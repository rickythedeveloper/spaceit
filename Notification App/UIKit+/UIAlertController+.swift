...
extension UIAlertController {
    ...
    static func editPageNameAlert(textFieldDelegate: FinderWorkspaceNavBar, pageName: String, doneAction: @escaping (_ text: String)->Void, cancelAction: @escaping ()->Void) -> UIAlertController {
        let ac = UIAlertController(title: "Edit name", message: nil, preferredStyle: .alert)
        ac.addTextField { (textField) in
            textField.placeholder = pageName
            textField.text = pageName
