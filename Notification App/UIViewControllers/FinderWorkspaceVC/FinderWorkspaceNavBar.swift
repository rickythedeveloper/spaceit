//
//  FinderWorkspaceNavBar.swift
//  Notification App
//
//  Created by Rintaro Kawagishi on 09/05/2020.
...
class FinderWorkspaceNavBar: UINavigationBar, WorkspaceAccessible {
    ...
    var finderWorkspaceVC: FinderWorkspaceVC
    var containerView: FinderStyleContainerView
    var pageForTableView: Page?
    var workspaceAccessible: WorkspaceAccessible?
    
    init(finderWorkspaceVC: FinderWorkspaceVC, containerView: FinderStyleContainerView, workspaceAccessible: WorkspaceAccessible?) {
...
extension FinderWorkspaceNavBar {
